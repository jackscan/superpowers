...
8. **finishing-a-development-branch** - Activates when tasks complete. Verifies tests, syncs spec deltas, presents options (merge/PR/keep/discard), cleans up worktree.
